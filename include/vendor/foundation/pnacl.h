/* pnacl.h  -  Foundation library  -  Public Domain  -  2013 Mattias Jansson /
 * Rampant Pixels
 *
...
FOUNDATION_API int pnacl_module_initialize(PP_Module module_id,
...
FOUNDATION_API const void *pnacl_module_interface(const char *interface,
        size_t length);
...
FOUNDATION_API void *pnacl_array_output(void *arr, uint32_t count,
                                        uint32_t size);
...
FOUNDATION_API void pnacl_post_log(hash_t context, error_level_t severity,
