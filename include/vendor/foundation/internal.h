...
Internal types and functions which are not for public use. The symbols defined
in this file may change at any time. */
...
FOUNDATION_API int _exception_initialize(void);

FOUNDATION_API void _exception_finalize(void);

// Internal functions

FOUNDATION_API uint32_t hashtable32_raw(hashtable32_t *table, size_t slot);

FOUNDATION_API uint64_t hashtable64_raw(hashtable64_t *table, size_t slot);
