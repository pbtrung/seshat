/* foundation.h  -  Foundation library  -  Public Domain  -  2013 Mattias
...
/*! Main entry point. Call this in your #main_initialize function to bootstrap
the foundation library and initialize all functionality. \param memory
Memory system declaration (use memory_system_malloc for default system
allocator) \param application  Application declaration \param config
Application configuration \return             0 if initialization successful, <0
if error */
...
/*! Main exit point. Call this in your #main_finalize function to cleanup the
foundation library and terminate all functionality. */
FOUNDATION_API void foundation_finalize(void);
...
FOUNDATION_API foundation_config_t foundation_config(void);
